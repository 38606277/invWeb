...
const transfer = (props) => {
  ...
  return (
    ...
    >
      ...
      >
        {(mainData?.bill_status || 0) != 0 ? (
          <ProCardCollapse title="流程进度">
        ...
        <ProCardCollapse title="基础信息">
          ...
          <Row>
            <Col xs={24} sm={10}>
              <Form.Item label="调拨编码" name="bill_code">
        ...
        <ProCardCollapse title="物流信息">
          <Row>
            <Col xs={24} sm={10}>
              <Form.Item label="运输方式" name="ship_method">
          ...
          <Row>
            <Col xs={24} sm={10}>
              <Form.Item label="物流厂商" name="ship_corp">
                <DictSelect disabled={disabled} dictCode="ship_corp" />
              </Form.Item>
            </Col>
            <Col xs={24} sm={10}>
              <Form.Item label="物流单号" name="ship_number">
