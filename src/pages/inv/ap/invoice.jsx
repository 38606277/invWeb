...
const invoice = (props) => {
    ...
    const save = (params) => {
        HttpService.post('reportServer/ap/invoice/createInvoice', JSON.stringify(params)).then((res) => {
    ...
    useEffect(() => {
        if (action === 'edit') {
            //初始化编辑数据
            HttpService.post('reportServer/ap/invoice/getInvoiceById', JSON.stringify({ invoice_id: id })).then(
                (res) => {
                    if (res.resultCode == '1000') {
                        setDisabled(true);
        ...
        >
            ...
            >
                ...
                >
                    ...
                    <Row>
                        <Col xs={24} sm={10}>
                            <Form.Item label="发票金额" name="invoice_amount"
                ...
                handleOk={(mainData, linesData) => {
                    ...
                    for (let i = 0; i < linesData.length; i++) {
                        ...
                        for (let j = 0; j < tableData.length; j++) {
                            ...
                            console.log(` mainData.po_header_id == tableData[j]['po_id']; ${mainData.po_header_id} == ${tableData[j]['po_id']}`)
                            console.log(` linesData[i]['line_id'] == tableData[j]['line_id']; ${linesData[i]['line_id']} == ${tableData[j]['line_id']}`)
