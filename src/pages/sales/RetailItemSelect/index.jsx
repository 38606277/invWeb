...
const Retail = ({ dispatch, salesAndRetail: { list = [] }, loading }) => {
  useEffect(() => {
    dispatch({
      type: 'salesAndRetail/fetch',
      payload: {
        count: 8,
      },
    });
...
export default connect(({ salesAndRetail, loading }) => ({
  salesAndRetail,
  loading: loading.models.salesAndRetail,
}))(Retail);
